...
// _ResultLabel — improved visual impact without adding color.
//
// Before: categoryLabel (11px mono, secondary) + doneMessage (22px Lora w400).
// After:  categoryLabel (unchanged) + appTitle (28px Lora w500).
//
// The jump from w400 → w500 and 22px → 28px gives the result line clear
// dominance over the surrounding content. The appTitle style is the largest
// serif in the system and its slightly tighter letterSpacing (1.5) makes the
// phrase feel considered rather than casual — all within the existing palette.
