...
/// Visually impactful result label.
///
/// Correct: large Lora serif text in full black — confident, settled.
/// Not quite: same large treatment in a muted tone with a thin horizontal
/// rule beneath to signal "pause and read on".
class _ResultLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final headline = isCorrect ? 'Correct.' : 'Not quite.';
    final subtext =
    ...
    return Column(
      ...
      children: [
        ...
        // Thin rule: full-width for correct, shorter for incorrect to
        // visually soften the "not quite" moment.
        SizedBox(
          width: isCorrect ? double.infinity : 48,
          child: Divider(
            height: 1,
            thickness: 1,
            color: isCorrect ? AppColors.text : AppColors.border,
          ),
        ),
        const SizedBox(height: 10),
        Text(
